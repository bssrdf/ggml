...
DECL_MMQ_CASE({type}, {src_type1});
DECL_MMQ_CASE({type}, {src_type2});
DECL_MMQ_CASE({type}, {src_type3});
"""
...
for type in TYPES_MMQ:
        src_type1 = "float"
        src_type2 = "half"
        src_type3 = "nv_bfloat16"
        with open(f"mmq-instance-{get_short_name(type)}.cu", "w") as f:
            f.write(SOURCE_MMQ.format(type=type, src_type1=src_type1, src_type2=src_type2, src_type3=src_type3))
